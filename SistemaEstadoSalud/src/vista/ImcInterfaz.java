...
public class ImcInterfaz extends javax.swing.JFrame 
{
    ...
    public ImcInterfaz() {
        ...
        rsscalelabel.RSScaleLabel.setScaleLabel(lblfondo,"src/imagen/FondoImc.png");
    ...
    private void initComponents() {
        ...
        botonCalcular.setBackground(new java.awt.Color(0, 153, 153));
        ...
        btnTabla.setBackground(new java.awt.Color(0, 153, 153));
        btnTabla.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnTabla.setText("Ver Tabla");
        btnTabla.setMaximumSize(new java.awt.Dimension(119, 25));
        btnTabla.setMinimumSize(new java.awt.Dimension(119, 25));
        ...
        btnMostrarLista.setBackground(new java.awt.Color(195, 195, 0));
        ...
        getContentPane().add(btnMostrarLista, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 90, 171, 40));
        ...
        btnDarBaja.setBackground(new java.awt.Color(195, 195, 0));
        ...
        getContentPane().add(btnDarBaja, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 160, 171, 40));

        btnModificar.setBackground(new java.awt.Color(195, 195, 0));
        ...
        getContentPane().add(btnModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 230, -1, 40));
